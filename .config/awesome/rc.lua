...
mymainmenu = awful.menu({ items = { { "Awesome", myawesomemenu, icons.archlabs },
                                    ...
                                    { "Run", "rofi -show run -theme /home/atidyshirt/.config/rofi/themes/rosebox.rasi" },
                                    { "Terminal", terminal }
                                  }
                        })
...
globalkeys = gears.table.join(
    ...
    awful.key({ "Mod1" }, "Return", function () awful.spawn(web_browser) end,
    ...
    awful.key({ modkey }, "x", function () awful.layout.inc(-1) end,
    ...
    -- Rofi
    awful.key({ modkey }, "d", function () awful.spawn("rofi -show run -theme /home/atidyshirt/.config/rofi/themes/rosebox.rasi") end,
              {description = "rofi launcher", group = "launcher"}),

    -- Needed for super to launch rofi through ksuperkey, see ~/.xprofile
    awful.key({ "Mod1" }, "F1", function () awful.spawn("rofi -show run -theme /home/atidyshirt/.config/rofi/themes/rosebox.rasi") end,
              {description = "rofi launcher", group = "launcher"})
)
...
clientkeys = gears.table.join(
    ...
    awful.key({ "Control", "Shift"   }, "j",   function (c) c:relative_move(  0,  dpi(40),   0,   0) end,
        {description =  "relative move", group = "client"}),
    awful.key({ "Control", "Shift"   }, "k",     function (c) c:relative_move(  0, -dpi(40),   0,   0) end,
        {description =  "relative move", group = "client"}),
    awful.key({ "Control", "Shift"   }, "h",   function (c) c:relative_move(-dpi(40),   0,   0,   0) end,
        {description =  "relative move", group = "client"}),
    awful.key({ "Control", "Shift"   }, "l",  function (c) c:relative_move( dpi(40),   0,   0,   0) end,
        {description = "relative move", group = "client"}),
    ...
    awful.key({ modkey }, "c",  function (c) awful.placement.centered(c,{honor_workarea=true}) end,
