...
theme.wallpaper = gears.filesystem.get_configuration_dir() .. "wallpapers/home_gruvbox_comfy_brown.jpg"

-- Load ~/.Xresources colors and set fallback colors
theme.xbackground = xrdb.background or "#262626"
theme.xforeground = xrdb.foreground or "#E1E1E1"
theme.xcolor0 = xrdb.color0 or "#262626"
...
theme.tasklist_fg_focus = "#62554A"
...
-- Volume bar
theme.volume_bar_active_color = "#62554A"
